...
bool callbacks::IsMultipointOn() {
	return g_menu.main.aimbot.multipoint.get(0);
}

bool callbacks::IsMultipointChestOn() {
	return g_menu.main.aimbot.multipoint.get(1);
}
...
bool callbacks::IsMultipointLegsOn() {
	return g_menu.main.aimbot.multipoint.get(3);
}

bool callbacks::IsMultipointFeetOn() {
	return g_menu.main.aimbot.multipoint.get(4);
}
