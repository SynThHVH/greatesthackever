...
public:
	void init() {
		...
		scale.setup("head scale", XOR("head_scale"), 1.f, 100.f, true, 0, 42.f, 1.f, XOR(L"%"));
		scale.AddShowCallback(callbacks::IsMultipointOn);
		RegisterElement(&scale);

		chest_scale.setup(XOR("chest scale"), XOR("chest_scale"), 1.f, 100.f, true, 0, 48.f, 1.f, XOR(L"%"));
		chest_scale.AddShowCallback(callbacks::IsMultipointChestOn);
		RegisterElement(&chest_scale);

		body_scale.setup(XOR("body scale"), XOR("body_scale"), 1.f, 100.f, true, 0, 72.f, 1.f, XOR(L"%"));
		body_scale.AddShowCallback(callbacks::IsMultipointBodyOn);
		RegisterElement(&body_scale);

		legs_scale.setup(XOR("legs scale"), XOR("legs_scale"), 1.f, 100.f, true, 0, 15.f, 1.f, XOR(L"%"));
		legs_scale.AddShowCallback(callbacks::IsMultipointLegsOn);
		RegisterElement(&legs_scale);

		feet_scale.setup(XOR("feet scale"), XOR("feet_scale"), 1.f, 100.f, true, 0, 20.f, 1.f, XOR(L"%"));
		feet_scale.AddShowCallback(callbacks::IsMultipointFeetOn);
		...
		autostopconditions.setup(XOR("stop mode"), XOR("autostopconditions"), { XOR("full"), XOR("slide") });
		RegisterElement(&autostopconditions, 1);
		...
		accuracy_boost.setup("accuracy boost", XOR("accuracy_boost"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		lagfix.setup(XOR("refine shots"), XOR("lagfix"));
		...
		zeusbot.setup(XOR("tasebot"), XOR("zeusbot"));
...
public:
	void init() {
		...
		choke_on_shot.setup(XOR("choke on shot"), XOR("chokeshot"));
		RegisterElement(&choke_on_shot, 1);
